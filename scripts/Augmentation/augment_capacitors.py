...
print("\n======================================")
print("    CAPACITOR AUGMENTATION STARTED")
print("======================================\n")
...
print("\n[STEP 3/10] Searching for capacitor annotation...")
...
print("\n[STEP 4/10] Cropping capacitor ROI...")
...
print("\n[STEP 5/10] Segmenting capacitor...")
...
if not contours:
    ...
    print("✗ ERROR: No capacitor contours found")
    exit()
...
print("✓ Largest capacitor-like contour selected")
print("  Contour area:", largest_area)


# Build clean final mask
...
# Slight dilation to retain component edges
...
print("✓ Capacitor segmented successfully")


# --------------------------------------------------
# 7. REMOVE ORIGINAL CAPACITOR
# --------------------------------------------------

print("\n[STEP 6/10] Removing original capacitor from PCB...")
...
print("✓ Original capacitor region removed")
print("✓ Background reconstructed")


# --------------------------------------------------
# 8A. HELPER FUNCTION: PASTE COMPONENT
# --------------------------------------------------
...
# --------------------------------------------------
# 8B. HELPER FUNCTION: ROTATE COMPONENT
# --------------------------------------------------
...
# --------------------------------------------------
# 8C. HELPER FUNCTION: SAVE RESULT
# --------------------------------------------------
...
print("\n[AUGMENTATION 1/5]")
print("→ Rotating capacitor by +5 degrees...")
...
save_result(
    result_rot5,
    f"{PCB_NAME}_capacitor_rotate_05.png",
    "rotate",
    "+5 degrees",
    x,
    y
...
print("\n[AUGMENTATION 2/5]")
print("→ Flipping capacitor horizontally...")
...
save_result(
    result_flip,
    f"{PCB_NAME}_capacitor_flip_horizontal.png",
    "flip",
    "horizontal",
    x,
    y
...
print("\n[AUGMENTATION 3/5]")
print("→ Moving capacitor by +10 pixels...")
...
save_result(
    result_move10,
    f"{PCB_NAME}_capacitor_move_10px.png",
    "move",
    "+10 px x-direction",
    new_x_10,
    new_y_10
...
print("\n[AUGMENTATION 4/5]")
print("→ Moving capacitor by +25 pixels...")
...
save_result(
    result_move25,
    f"{PCB_NAME}_capacitor_move_25px.png",
    "move",
    "+25 px x-direction",
    new_x_25,
    new_y_25
...
print("\n[AUGMENTATION 5/5]")
print("→ Rotating capacitor by +15 degrees...")
...
save_result(
    result_rot15,
    f"{PCB_NAME}_capacitor_rotate_15.png",
    "rotate",
    "+15 degrees",
    x,
    y
...
cv2.imshow(
    "Capacitor Rotate 5 degrees",
    create_preview(result_rot5)
)

cv2.imshow(
    "Capacitor Horizontal Flip",
...
print("\n======================================")
print("   CAPACITOR AUGMENTATION COMPLETED")
print("======================================")

print("\nGenerated 5 full-PCB images:")
print("  1. Rotate +5°")
